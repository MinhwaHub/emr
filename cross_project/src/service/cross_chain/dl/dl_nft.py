...
spark = SparkSession.builder.appName("dl_nft").getOrCreate()
...
payload = ""
headers = {}
conn.request("GET", "/api/v2/tokens?type=ERC-721", payload, headers)
...
try:
    ...
    repair_glue_partitions(spark, schema_name, data_layer, "nft")
...
messenger.send_slack(text=" *FINISH CRAWLING NFT*")
spark.stop()
